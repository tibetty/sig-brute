...
```gradle
implementation 'me.tibetty:sig-brute:1.1.0'
```
...
4. Tag and push: `git tag v1.1.0 && git push origin v1.1.0` — triggers [`.github/workflows/release.yml`](../.github/workflows/release.yml) (upload to OSSRH Staging API, then promote to namespace `me.tibetty` with automatic release).
